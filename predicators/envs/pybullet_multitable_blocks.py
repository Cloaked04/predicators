...
from typing import Any, ClassVar, Dict, List, Tuple, Optional, Union
...
class PyBulletMultiTableBlocksEnv(PyBulletEnv, BlocksEnv):
    ...
    robo_x = sum(pose[0] for pose in cls._default_table_poses)/ len(cls._default_table_poses)
    robo_y = sum(pose[1] for pose in cls._default_table_poses)/ len(cls._default_table_poses)
    robo_z = 0.01
